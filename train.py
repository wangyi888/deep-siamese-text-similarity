...
tf.flags.DEFINE_string("word2vec_model", "../match_law/datasets/gamedatas/w2v_xingshi.txt", "word2vec pre-trained embeddings file (default: None)")
...
tf.flags.DEFINE_string("training_files", "./datasets/datas.txt", "training file (default: None)")  #for sentence semantic similarity use "train_snli.txt"
